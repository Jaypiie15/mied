...
<hr>
    ...
    <form method="POST" action="{{ route('add-meatcut') }}" class="form-horizontal form-label-left" id="form" enctype="multipart/form-data">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <input id="files" type="file"  class="form-control col-md-7 col-xs-12" name="images[]" multiple="">
